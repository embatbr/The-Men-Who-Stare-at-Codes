...
When we say an event $E$ has a probability $P(E) = 30\%$, that doesn't mean we will have 30 occurrences of $E$ for each 100 repetitions of the experiment, but that when the number is really big, the outcomes of $E$ approach this percentage. The leap here is named \textit{relative frequency}, that is the ratio
